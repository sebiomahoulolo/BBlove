...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, 'en_attente')");
    $stmt->execute([$nom, $prenom, $ville, $telephone, $titre, $description, $date, $heure, $lieu, $image, $payant, $montant, 'atelier']);
...
<head>
  ...
  <meta name="viewport" content="width=device-width, initial-scale=1"> <!-- Meta important pour mobile -->
  ...
  <form method="POST" enctype="multipart/form-data" class="card p-4 shadow-sm">
    ...
    <div class="row">
      ...
      <div class="col-12 col-md-6 mb-3">
        ...
        <input type="tel" class="form-control" name="telephone" pattern="[0-9]{8,15}" placeholder="Ex : 770000000" required>
      </div>
    </div>
